...
namespace WebGLSupport
{
    static class WebGLWindowPlugin
    {
        ...
        [DllImport("__Internal")]
        public static extern string WebGLWindowInjectLocalStorage();
#else
        ...
        public static string WebGLWindowInjectLocalStorage() { return PlayerPrefs.GetString("nakama.authToken", null);  }
